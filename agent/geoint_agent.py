...
def selftest() -> int:
    ...
    try:
        ...
        if e.code == 401:
            ...
            print("  Richiesta rifiutata: di solito un parametro non valido per")
            print("  questa famiglia di modelli.")
        if detail:
            print(f"  Risposta: {detail}")
        return 1
    ...
    limits = {k: v for k, v in headers.items() if k.lower().startswith("x-ratelimit")}
    if limits:
        print("  quote residue :")
